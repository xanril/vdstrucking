...
namespace VDSTrucking.Controllers
{
    public class TrucksController : Controller
    {
        ...
        public TrucksController(VDSDBContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("TruckID,Name")] Truck truck)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TruckID,Name")] Truck truck)
        {
            if (id != truck.TruckID)
            {
                return NotFound();
